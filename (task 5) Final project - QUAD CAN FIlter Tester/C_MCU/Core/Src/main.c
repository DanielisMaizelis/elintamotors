...
/* USER CODE BEGIN PV */
// Global CAN reception messages
uint32_t gCanIRQReceivedMsg;

// Global Uart reception messages
uint8_t gUartConnRequest;

// Global Lin reception messages
uint8_t gLinIRQMsg[LIN_FRAME_LEN];
