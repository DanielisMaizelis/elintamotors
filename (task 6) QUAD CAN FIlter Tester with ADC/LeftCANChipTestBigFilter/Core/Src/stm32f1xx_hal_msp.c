...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(ADC_CURRENT_SENSOR_GPIO_Port, ADC_CURRENT_SENSOR_Pin);

    HAL_GPIO_DeInit(ADC_DT_14_GPIO_Port, ADC_DT_14_Pin);

    HAL_GPIO_DeInit(ADC_DT_23_GPIO_Port, ADC_DT_23_Pin);
